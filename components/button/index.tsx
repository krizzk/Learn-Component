...
//wawsdftgauywihuoijpdegdbnmdaw
    ...
    export const SuccessOutlaneButton = ({ children, type, onClick, className }: Props) => {
        return (
            <button className={`text-sm bg-white outline outline-offset-2 outline-1 outline-green-500 text-black rounded-md py-2 px-4 hover:bg-green-700 hover:text-white font-bold ${className}`}
                type={type} onClick={() => { if (onClick) onClick() }}>
    {children}
        </button>
    )
    ...
    return (
        <button className={`text-sm bg-white outline outline-offset-2 outline-1 outline-yellow-500 text-black rounded-md py-2 px-4 hover:bg-yellow-600 hover:text-white font-bold ${className}`}
            type={type} onClick={() => { if (onClick) onClick() }}>
            {children}
        </button>
    )
    ...
    return (
        <button className={`text-sm bg-white outline outline-offset-2 outline-1 outline-red-500 text-black rounded-md py-2 px-4 hover:bg-red-700 hover:text-white font-bold ${className}`}
            type={type} onClick={() => { if (onClick) onClick() }}>
            {children}
        </button>
    )
